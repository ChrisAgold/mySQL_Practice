...
SELECT from_date as original, DATE_FORMAT(from_date, "%M %d %Y") as formatted_date
FROM salaries;
...
SELECT *
FROM employees
WHERE first_name IN ('Elvis', 'Sumant', 'Berni', 'Lillian');

select *
from employees
where first_name LIKE 'Elv%'
  and last_name LIKE '_e%';

select *
from employees
where birth_date between '1954-05-01' and '1956-04-20';
